...
describe('/api/interfaces/ethernets', function () {
  ...
  describe('when GET', function () {
    ...
    it('should return a valid `ethernets` collection response', function (done) {
      api
        .get('/interfaces/ethernets')
        .set('Accept', 'application/vnd.api+json')
        .expect('Content-Type', 'application/vnd.api+json')
        .expect(function (res) {
          ...
          body.ethernets.should.be.an.Array;
        })
        .expect(200, done);
    });
    ...
    it('should reflect the proper pagination object by default', function (done) {
      api
        ...
        .expect(function (res) {
          ...
          body.meta.should.have.property('ethernets');
          body.meta.ethernets.should.have.properties([
            'total',
            'offset',
            'limit'
          ]);
          body.meta.ethernets.limit.should.be.equal(10);
          body.meta.ethernets.offset.should.be.equal(0);
        })
        .expect(200, done);
    });
      ...
      it('should reflect the proper pagination object', function (done) {
        api
          ...
          .expect(function (res) {
            ...
            body.meta.ethernets.limit.should.be.equal(2);
            body.meta.ethernets.offset.should.be.equal(1);
          })
          .expect(200, done);
      });
    });
