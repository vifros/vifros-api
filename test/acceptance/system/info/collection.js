...
describe('/api/system/info', function () {
  ...
  describe('when GET', function () {
    ...
    it('should return a valid `info` collection response', function (done) {
      api
        .get('/system/info')
        .set('Accept', 'application/vnd.api+json')
        .expect('Content-Type', 'application/vnd.api+json')
        .expect(function (res) {
          ...
          body.info.should.be.an.Array;
          body.info.should.have.a.lengthOf(7);
        })
        .expect(200, done);
    });
  });
